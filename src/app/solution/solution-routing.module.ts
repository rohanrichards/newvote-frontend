...
const routes: Routes = [
	...
	{ path: 'create', component: SolutionCreateComponent, data: { title: extract('New Solution') } },
	{ path: 'create/:id', component: SolutionCreateComponent, data: { title: extract('New Solution') } },
	{ path: 'edit/:id', component: SolutionEditComponent, data: { title: extract('Edit Solution') } },
	{ path: ':id', component: SolutionViewComponent, data: { title: extract('Solution') } },
];
